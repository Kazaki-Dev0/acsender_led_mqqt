...
#include <PubSubClient.h> // Biblioteca de comunicação para MQTT
#include <ArduinoJson.h> // Biblioteca de json
...
//função que dispara quando uma mensagem é recebida no tópico inscrito/ comunicação
